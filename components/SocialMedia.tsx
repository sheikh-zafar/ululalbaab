...
const socialLinks = [
    {
        ...
        svg: (
            <svg fill="#dcbc23" className="w-5 h-5 sm:w-6 sm:h-6 lg:w-8 lg:h-8" viewBox="0 0 24 24">
    ...
    },
    {
        ...
        svg: (
            <svg fill="#dcbc23" className="w-5 h-5 sm:w-6 sm:h-6 lg:w-8 lg:h-8" viewBox="0 0 32 32">
        ...
        <Container className="xxl:mt-20 xl:mt-20 lg:mt-20 sm:mt-12 md:mt-12 s:mt-8 xs:mt-8 xxs:mt-8" sx={{ textAlign: "center" }}>
            <div className="flex flex-nowrap justify-center gap-6 my-10 ">
                {socialLinks.map(({ name, href, svg }, idx) => (
                    ...
                    >
                        {svg}
                        <span className="text-sunflower mt-1 xs:hidden s:hidden xxs:hidden">{name}</span>
                    </Link>
                ))}
            </div>
        </Container>
